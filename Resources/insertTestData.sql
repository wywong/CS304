...
INSERT INTO Borrower VALUES ('00000006','1234','Evan Tuesday','2 Library Road','2509052422','et@lib.ubc.ca','000000006','2013-09-06','student');

INSERT INTO Borrower VALUES ('00000007','1234','Evan Wednesday','2 Library Road','2509052422','ew@lib.ubc.ca','000000007','2013-09-06','student');

INSERT INTO Borrower VALUES ('00000008','1234','Evan Thursday','2 Library Road','2509052422','etr@lib.ubc.ca','000000008','2013-09-06','student');

INSERT INTO Borrower VALUES ('00000009','1234','Evan Saturday','2 Library Road','2509052422','esat@lib.ubc.ca','000000009','2013-09-06','student');

INSERT INTO Borrower VALUES ('00000010','1234','Evan Sunday','2 Library Road','2509052422','esun@lib.ubc.ca','000000010','2013-09-06','student');

INSERT INTO Borrower VALUES ('00000011','1234','Evan Everyday','2 Library Road','2509052422','ever@lib.ubc.ca','000000011','2013-09-06','student');

INSERT INTO Borrower VALUES ('00000003','1234','Wilson Wong','Library Road','2509052422','wwong@lib.ubc.ca','000000003','2012-12-12','faculty');

INSERT INTO Borrower VALUES ('00000012','1234','Wilson Wang','Library Road','2509052422','wwang@lib.ubc.ca','000000012','2012-12-12','faculty');

INSERT INTO Borrower VALUES ('00000013','1234','Wilson Weng','Library Road','2509052422','wweng@lib.ubc.ca','000000013','2012-12-12','faculty');

INSERT INTO Borrower VALUES ('00000004','1234','Beyonce Knowles','Library Road','2509052422','bknowles@lib.ubc.ca','000000004','2014-06-11','staff');

INSERT INTO Borrower VALUES ('00000014','1234','Katy Block Parry','Library Road','2509052422','kbp@lib.ubc.ca','000000014','2014-06-11','staff');

INSERT INTO Borrower VALUES ('00000015','1234','Scarlett Johanson','Library Road','2509052422','jh@lib.ubc.ca','000000015','2014-06-11','staff');

INSERT INTO Borrower VALUES ('00000005','1234','Johnny Depp','Library Road','2509052422','jdepp@lib.ubc.ca','000000005','2000-01-08','staff');
...
INSERT INTO BookCopy VALUES ('CD.45.098', 0, 'out');
...
INSERT INTO BookCopy VALUES ('FG.235.331', 0, 'out');
...
INSERT INTO BookCopy VALUES ('EH.825.321', 2, 'out');
